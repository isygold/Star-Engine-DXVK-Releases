...
Open Star Emulator.
Navigate to the "Contents" menu option.
Install the "dxvk-2.7.1.wcp" file.
...
/storage/emulated/0/Android/data/[package_name]/files/starengine.ini
...
*Name:DXVK_CONFIG_FILE *Value: the value should be the directory where your dxvk.conf file isfound in your device (if you choose the wcp file install method
